...
public class Climber {
	...
	TalonSRX Climber_Winch_3 = null;
	
	double output;
	public Climber(int POne, int WOne,int WTwo, int WThree) {
		Climber_Pully_1 = new TalonSRX(POne);
	    Climber_Winch_1 = new TalonSRX(WOne);
	    Climber_Winch_2 = new TalonSRX(WTwo);
	    Climber_Winch_3 = new TalonSRX(WThree);
	    
	    Climber_Winch_3.setInverted(true);
...
//		  Climber_Winch_2.set(ControlMode.PercentOutput, output);
		  ...
		  if(Pully > 0 && Pully > 0.1) {
			  ...
			  Climber_Winch_3.set(ControlMode.PercentOutput, Pully);
			  ...
			  Climber_Winch_3.set(ControlMode.PercentOutput, 1);
			  ...
			  Climber_Winch_3.set(ControlMode.PercentOutput, 0);
